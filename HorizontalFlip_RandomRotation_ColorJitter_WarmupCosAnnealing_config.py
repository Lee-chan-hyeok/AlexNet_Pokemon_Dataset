...
exp_name = f"HorizontalFlip_RandomRotation_ColorJitter_Epoch{epochs}_Batch{batch_size}_Lr{learning_rate}_SchedulerWarmupCosAnnealing_Smoothing{loss_label_smoothing}/"
# =============================================================
